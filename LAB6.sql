...
SELECT ACTNO,CNAME,BNAME,ADATE,AMOUNT AS BALANCE
INTO DEPOSIT_COPY
FROM BANK_DEPOSIT;
...
SELECT STUDENT_NAME,CITY,BRANCH
INTO CS_STUDENTS
FROM STUDENT
...
SELECT * 
INTO BULL_BRANCH_STUDENTS
FROM STUDENT
WHERE BRANCH IS NULL;

--17. Copy all STUDENT records and rename SPI as PERFORMANCE into STUDENT_COPY. 
SELECT STDID,STUDENT_NAME,BRANCH,EMAIL,SPI AS PERFORMANCE
INTO STUDENT_COPY
FROM STUDENT;
