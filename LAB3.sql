...
WHERE (BRANCH='COMPUTER' OR BRANCH='CHEMICAL' OR BRANCH='CIVIL') AND STDID<104;
...
WHERE (BRANCH!='COMPUTER' OR BRANCH!='CIVIL');
...
SELECT * FROM STUDENT
WHERE (BRANCH='MECHANICAL' OR BRANCH='CHEMICAL') AND SPI>8;
...
SELECT * FROM STUDENT
WHERE SPI>8 AND (BRANCH!='COMPUTER' OR BRANCH!='CIVIL');
...
SELECT SNAME FROM STUDENT
WHERE CITY!='RAJKOT' AND CITY!='SURAT';
